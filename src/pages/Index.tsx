          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-foreground mb-6 leading-relaxed">
                ...
                Также варю электродом и полуавтоматом. Ремонт всего, что сделано из цветных металлов: нержавеющая сталь, магний, алюминий, латунь, медь и сплавы чугуна.
              </p>
              <div className="bg-gradient-to-r from-primary/10 to-primary/5 border-l-4 border-primary p-6 rounded-lg shadow-md">
                <p className="text-secondary font-semibold text-lg">
                  👆 Для девушек, женщин, бабушек, дедушек — за сварочные пятиминутные работы денег не возьму! 
                  Если сломалась кастрюлька, тяпка, детская коляска/люлька, велосипед и т.п. — приносите, не стесняйтесь, починю. Максимум за шоколадку/чай/кофе.
                </p>
              </div>
            </div>
